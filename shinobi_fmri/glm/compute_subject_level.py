...
"""
    ...
    z_maps_out_dir = op.join(path_to_data, processed_dirname, "subject-level", sub, "z_maps")
    beta_maps_out_dir = op.join(path_to_data, processed_dirname, "subject-level", sub, "beta_maps")
