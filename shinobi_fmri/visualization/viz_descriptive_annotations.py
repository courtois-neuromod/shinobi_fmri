...
def create_annotations_figure(count_df, duration_df, output_path):
    ...
    # Add panel label A
    ax.text(-0.15, 1.05, 'A', transform=ax.transAxes, fontsize=6, fontweight='bold', va='bottom')
    ...
    ax.tick_params(axis='both', labelsize=5, width=0.3, length=2)
    # Add panel label B
    ax.text(-0.15, 1.05, 'B', transform=ax.transAxes, fontsize=6, fontweight='bold', va='bottom')
